...
?>
            ...
            <div class="yith-wcet-section-container">
                <div class="yith-wcet-section-title"> <?php echo __('Header Logo', 'yith-wcet') ?></div>
                <table class="yith-wcet-section-table">
                    <tr>
                        <td class="yith-wcet-table-title">
                            <label><?php echo __('Logo', 'yith-wcet') ?></label>
                        </td>
                        <td class="yith-wcet-table-content">
                            ...
                            <div class="yith-wcet-table-description"><?php echo __('[Upload a new logo, or select your default logo as you have set in "Email Template Settings"]', 'yith-wcet') ?></div>
                        </td>
                    </tr>
                </table>        
            ...
            <div class="yith-wcet-section-container">
                <div class="yith-wcet-section-title"> <?php echo __('Style Options', 'yith-wcet') ?></div>
                <table class="yith-wcet-section-table">
                    <tr>
                        <td class="yith-wcet-table-title">
                            <label><?php echo __('Base Color', 'yith-wcet') ?></label>
                        </td>
                        <td class="yith-wcet-table-content">
                    ...
                    <tr>
                        <td class="yith-wcet-table-title">
                            <label><?php echo __('Body Color', 'yith-wcet') ?></label>
                        </td>
                        <td class="yith-wcet-table-content">
                    ...
                    <tr>
                        <td class="yith-wcet-table-title">
                            <label><?php echo __('Background Color', 'yith-wcet') ?></label>
                        </td>
                        <td class="yith-wcet-table-content">
                    ...
                    <tr>
                        <td class="yith-wcet-table-title">
                            <label><?php echo __('Text Color', 'yith-wcet') ?></label>
                        </td>
                        <td class="yith-wcet-table-content">
            ...
            <div class="yith-wcet-section-container">
                <div class="yith-wcet-section-title"> <?php echo __('Preview', 'yith-wcet') ?></div>
                <table class="yith-wcet-section-table">
                    <tr>
                        <td class="yith-wcet-table-title">
                            <label><?php echo __('Preview', 'yith-wcet') ?></label>
                        </td>
                        <td class="yith-wcet-table-content">
                            <a class="yith-wcet-nofocus" target="_blank" href="<?php echo admin_url('?yith_wcet_preview_mail=1&template_id=' . $post->ID)?>">
                                <input type="button" class="button-secondary" value="<?php echo __('Preview Template', 'yith-wcet')?>">
                            </a>
                            <div class="yith-wcet-table-description"><?php echo __('[You need to publish or update the template before displaying the correct preview]', 'yith-wcet') ?></div>
                        </td>
                    </tr>
                </table>        
            </div><!-- section-container -->
...
if (! function_exists( 'yith_wcet_insert_image_uploader' )){
    function yith_wcet_insert_image_uploader(){
        ...
        wp_enqueue_media();
        ?>
            <input type="button" name="upload-btn" id="yith-wcet-upload-btn" class="button-secondary" value="<?php echo __('Upload', 'yith-wcet')?>">
            <input type="button" id="yith-wcet-custom-logo-btn" class="button-secondary" value="<?php echo __('My Default Logo', 'yith-wcet')?>">
        <?php
    }
}
