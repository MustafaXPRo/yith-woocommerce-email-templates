    ...
    class YITH_WCET_Admin {
        ...
        */
        public function email_extra_settings( $settings ){
            ...
            $settings[] = array(
                    ...
                    'name'              => __( 'Email Template', 'yith-wcet' ),
                    'type'              => 'select',
                    'desc_tip'              => __( 'Select the email template that you want to use for your emails!', 'yith-wcet' ),
        ...
        */
        ...
        public function post_type_register() {
            $labels = array(
                'name'                  => __('Email Templates', 'yith-wcet'),
                'singular_name'         => __('Email Template', 'yith-wcet'),
                'add_new'               => __('Add Email Template', 'yith-wcet'),
                'add_new_item'          => __('Add new Email Template', 'yith-wcet'),
                'edit_item'             => __('Edit Email Template', 'yith-wcet'),
                'view_item'             => __('View Email Template', 'yith-wcet'),
                'not_found'             => __('Email Template not found', 'yith-wcet'),
                'not_found_in_trash'    => __('Email Template not found in trash', 'yith-wcet')
            );
        ...
        public function register_metabox(){
            add_meta_box('yith-wcet-metabox', __('Template Options', 'yith-wcet'), array( $this, 'metabox_render'), 'yith-wcet-etemplate', 'normal', 'high');
        }
        ...
        public function plugin_row_meta( $plugin_meta, $plugin_file, $plugin_data, $status ) {
            ...
            if ( defined( 'YITH_WCET_FREE_INIT' ) && YITH_WCET_FREE_INIT == $plugin_file ) {
                $plugin_meta[] = '<a href="' . $this->doc_url . '" target="_blank">' . __( 'Plugin Documentation', 'yith-wcet' ) . '</a>';
            }
            return $plugin_meta;
        }
        ...
        public function register_panel() {
            ...
            $args = array(
                ...
                'parent_slug'      => '',
                'page_title'       => __( 'Email Templates', 'yith-wcet' ),
                'menu_title'       => __( 'Email Templates', 'yith-wcet' ),
